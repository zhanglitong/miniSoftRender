...
namespace   FE
{
    ...
    protected:
        static  Pipeline    createPipeline(FEContext& ctx,FEDevice& device,RenderPass renderPass,FEPipeline::CreateInfo& cInfo,XMLNode* node,const String& prefix,const char* plType);
