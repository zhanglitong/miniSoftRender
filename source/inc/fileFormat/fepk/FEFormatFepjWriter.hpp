...
#include    "FEFormatFepj.hpp"
namespace   FE
{
    DEFINE_CLASS_UUID(FEFormatFepjWriter,"{F3B63ABF-D379-4F2E-9877-88D0184D59C2}");

    class   FEFormatFepjWriter :public FEStreamWriter
    {
    public:
        using   Header  =   FEFepjHeader;
    public:
        IMPLEMENT_CLASS_REFLECT(FEFormatFepjWriter)
    public:
        FEFormatFepjWriter(FEContext& ctx)
            :FEStreamWriter(ctx)
        {}
        FEFormatFepjWriter(const FEFormatFepjWriter& other)
        ...
        {
            return  FEFepjFormat::formats(classId());
        }
        /// <summary>
        /// 写文件
        /// </summary>
    ...
    public:
        ...
        {
            return  FEFepjFormat::formats(UUIDOF(FEFormatFepjWriter));
        }
    protected:
        /// <summary>
        /// 查询一个对象的依赖对象
