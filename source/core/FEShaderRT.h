...
namespace   FE
{
    ...
    struct	FEShaderRT
	{
        ...
        template <typename U>
        void    regResource(const IResource<U>& value,unsigned binding)
        {
            assert(!_resource[binding].ptr);
            _resource[binding].ptr      =   (void **)&value.ptr;
            _resource[binding].size     =   IResource<U>::Size;
        }
        template <typename U>
    ...
    {                                                                   \
        ...
        static IShader*   shaderInterface()                             \
        {                                                               \
    ...
    #define SHADER_API(CLASS)    FE::ExportShader<CLASS>::shaderInterface()


    struct  ShaderModule
    {
        IShader*    _api        =   nullptr;
        FEShaderRT* _instance   =   nullptr; 
