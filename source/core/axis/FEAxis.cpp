...
namespace   FE
{
    ...
    FEBrowseAxis::FEBrowseAxis(BrowseAxisType type, FEContext& context) :FEAxis(AxisTypeBase, context)
        , _browseAxisType(type)
    {
    }
    FEBrowseAxis::~FEBrowseAxis() {}
}
